...
class IBP_Icons {
	...
	public static function all() {
		return array(
			...
			'cal'       => array( 'Randevu', '<path d="M3 6a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2zM16 2v4M8 2v4M3 10h18M12 13v5M9.5 15.5h5"/>' ),
			'classes'   => array( 'Ders', '<path d="M6 6v12M18 6v12M3 9v6M21 9v6M6 12h12"/>' ),
			'bed'       => array( 'Oda', '<path d="M2 20V8M2 14h20v6M22 20v-6a4 4 0 0 0-4-4h-8v4M6 12a2 2 0 1 0 0-4a2 2 0 1 0 0 4"/>' ),
			'box'       => array( 'Sipariş', '<path d="M21 8l-9-5-9 5 9 5 9-5zM3 8v8l9 5 9-5V8M12 13v8"/>' ),
			'stock'     => array( 'Stok', '<path d="M4 5v14M8 5v14M12 5v14M15 5v14M20 5v14"/>' ),
			'leads'     => array( 'Talepler', '<path d="M3 4h5v16H3zM10 4h5v10h-5zM17 4h4v7h-4z"/>' ),
			'network'   => array( 'Bağlı işletmeler', '<rect x="9" y="2" width="6" height="6" rx="1.5"/><rect x="2" y="16" width="6" height="6" rx="1.5"/><rect x="16" y="16" width="6" height="6" rx="1.5"/><path d="M12 8v4M5 16v-2a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v2"/>' ),
			'check'     => array( 'Onay', '<path d="M5 12l5 5L20 7"/>' ),
			'utensils'  => array( 'Restoran', '<path d="M3 2v7a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V2M7 2v20M21 15V2a5 5 0 0 0-5 5v6a2 2 0 0 0 2 2h3zm0 0v7"/>' ),
			'scissors'  => array( 'Kuaför', '<circle cx="6" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M20 4L8.1 15.9M14.5 14.5L20 20M8.1 8.1L12 12"/>' ),
			'wrench'    => array( 'Servis', '<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.8-3.8a6 6 0 0 1-7.9 7.9l-6.9 6.9a2.1 2.1 0 0 1-3-3l6.9-6.9a6 6 0 0 1 7.9-7.9z"/>' ),
			'music'     => array( 'Sahne', '<path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/>' ),
			'paw'       => array( 'Evcil hayvan', '<circle cx="11" cy="4" r="2"/><circle cx="18" cy="8" r="2"/><circle cx="20" cy="16" r="2"/><path d="M9 10a5 5 0 0 1 5 5v3.5a3.5 3.5 0 0 1-6.8 1.1 1.8 1.8 0 0 0-1.4-1.3 3.5 3.5 0 0 1 .4-6.9A5 5 0 0 1 9 10z"/>' ),
			'dumbbell'  => array( 'Spor', '<path d="M6.5 6.5l11 11M21 21l-1-1M3 3l1 1M18 22l4-4M2 6l4-4M3 10l7-7M14 21l7-7"/>' ),
			'book'      => array( 'Eğitim', '<path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20V2H6.5A2.5 2.5 0 0 0 4 4.5v15zM4 19.5A2.5 2.5 0 0 0 6.5 22H20v-5"/>' ),
			'arrow'     => array( 'Ok', '<path d="M5 12h14M13 6l6 6-6 6"/>' ),
			'search'    => array( 'Ara', '<circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/>' ),
			'info'      => array( 'Bilgi', '<circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/>' ),
			'trend'     => array( 'Yükselen', '<path d="M22 7l-8.5 8.5-5-5L2 17"/><path d="M16 7h6v6"/>' ),
			'flame'     => array( 'Popüler', '<path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.4-.5-2-1-3-1.1-2.1-.2-4 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.2.4-2.3 1-3.3.3 1.4 1.3 2.8 2.5 2.8z"/>' ),
			'home'      => array( 'Ana sayfa', '<path d="M3 11l9-8 9 8M5 10v10h14V10M10 20v-6h4v6"/>' ),
			'doc'       => array( 'Özgeçmiş', '<path d="M14 3H6a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9zM14 3v6h6M9 18a3 3 0 0 1 6 0M12 14a2 2 0 1 0 0-4a2 2 0 0 0 0 4"/>' ),
			'gift'      => array( 'Etkinliklerim', '<path d="M20 12v9H4v-9M2 7h20v5H2zM12 21V7M12 7H7.5a2.5 2.5 0 0 1 0-5C11 2 12 7 12 7zM12 7h4.5a2.5 2.5 0 0 0 0-5C13 2 12 7 12 7z"/>' ),
			'quote'     => array( 'Teklif', '<path d="M4 4h16v16H4zM8 9h8M8 13h8M8 17h5"/>' ),
